...
public class AdminController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not found",
                    content = @Content) })
    @PostMapping("private/save/update/user-xref")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = " Not found",
                    content = @Content) })
    @PostMapping("private/user-xref/activate/deactivate/by user")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = " Not found",
                    content = @Content) })
    @PostMapping("private/permission/add")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = " Permission Not found",
                    content = @Content) })
    @PutMapping("private/permission/update")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Permissions Not found",
                    content = @Content) })
    @GetMapping("private/permission/fetch-all")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Permission Not found",
                    content = @Content) })
    @PutMapping("private/permission/activate/deactivate/by user")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = " User Not found",
                    content = @Content) })
    @GetMapping("private/user details")
